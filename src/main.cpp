...
const string strMessageMagic = "Poison Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 >= 0 && pindexBest->nHeight+1 <= 5)
    {
		nSubsidy = 0 * COIN;  
    } 
	else if(pindexBest->nHeight+1 >= 6 && pindexBest->nHeight+1 <= 250)
    {
		nSubsidy = 1000 * COIN;  
    } 	
	...
	else if(pindexBest->nHeight+1 >= 501 && pindexBest->nHeight+1 <= 1000)
    {
		nSubsidy = 200 * COIN;  
    } 	
	...
	else if(pindexBest->nHeight+1 >= 1501 && pindexBest->nHeight+1 <= 2000)
    {
		nSubsidy = 50 * COIN;  
    } 	
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 >= 1000 && pindexBest->nHeight+1 <= 1500)
    {
		nSubsidy = 10 * COIN;  
    } 
	else if(pindexBest->nHeight+1 >= 1501 && pindexBest->nHeight+1 <= 2000)
	...
	else if(pindexBest->nHeight+1 >= 2001 && pindexBest->nHeight+1 <= 2500)
    {
		nSubsidy = 50 * COIN;  
    } 
	else if(pindexBest->nHeight+1 >= 2501 && pindexBest->nHeight+1 <= 3000)
    {
		nSubsidy = 25 * COIN;  
    } 
	else if(pindexBest->nHeight+1 >= 3001)
    {
...
#ifdef ENABLE_WALLET
// poison: attempt to generate suitable proof-of-stake
