...
int nAnonymizePoisonAmount = 500;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Poison
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Poison
    // Mac: ~/Library/Application Support/Poison
    // Unix: ~/.Poison
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Poison";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Poison.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Poisond.pid"));
