...
static const int64_t DARKSEND_COLLATERAL = (15000*COIN);
static const int64_t DARKSEND_FEE = (0.0001*COIN);
static const int64_t DARKSEND_POOL_MAX = (150000.99*COIN);
...
static const int64_t MAX_MONEY = 4000000000 * COIN; // 4M PoW coins
