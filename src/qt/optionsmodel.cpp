...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizePoisonAmount"))
        settings.setValue("nAnonymizePoisonAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizePoisonAmount = settings.value("nAnonymizePoisonAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizePoisonAmount"))
        SoftSetArg("-anonymizePoisonamount", settings.value("nAnonymizePoisonAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizePoisonAmount:
            nAnonymizePoisonAmount = value.toInt();
            settings.setValue("nAnonymizePoisonAmount", nAnonymizePoisonAmount);
            emit anonymizePoisonAmountChanged(nAnonymizePoisonAmount);
            break;
        default:
            break;
        }
