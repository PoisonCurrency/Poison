...
!define URL http://www.poison.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/poison.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\poison-qt.exe
...
OutFile poison-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/poison-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/poisond.exe
    ...
    #Delete /REBOOTOK $INSTDIR\poison.exe
...
Section -post SEC0001
    ...
    #    WriteRegStr HKCR "bitcoin\Poison\open\command" "" '"$INSTDIR\bitcoin-qt.exe" "$$1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\poison-qt.exe
